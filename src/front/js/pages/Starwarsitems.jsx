                        ...
                        <div className="card h-100 shadow-sm bg-dark">
                            ...
                            <div className="card-body d-flex flex-column">
                                ...
                                <div className="mt-auto d-flex justify-content-between">
                                    <button className="btn btn-outline-success" onClick={() => handleDetails(item.uid, item.url)}>
                                        Detalles
                                    </button>
                                    <button className={`btn btn-${store.favorites.includes(item.name) ? "warning": "outline-warning"}`} onClick={() => handleFavorite(item.name)}>
